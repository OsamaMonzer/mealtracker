...
const INGREDIENTS = [
  ...
  { name: 'White Rice (Raw)', category: 'Carb', brand: '', status: 'Raw', calories_100g: 365, protein_100g: 7.1, carbs_100g: 80.0, fat_100g: 0.7, price_kg: 2.0, notes: '1g raw approx 2.8g cooked' },
...
export async function GET() {
  try {
    ...
    for (const item of INGREDIENTS) {
      ...
      await db.run(
        `INSERT INTO ingredients (name, category, brand, status, calories_100g, protein_100g, carbs_100g, fat_100g, price_kg, notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
